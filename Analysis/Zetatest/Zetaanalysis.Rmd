...
W2T <- read.csv("E:/Florian_paper/Florian/Aligned_Data/Analysable_data/wrangled_Data/Zetatests/W2T.csv") %>% mutate(Behv = 'W2T_HIT')
...
W2TU <- join  %>% filter(W2T_HIT==1| Whisk==1) %>% select(unit)
